...
#TEST CREDIT CARD : 4242 4242 4242, any info in cvc and date

buplishable_key = 'pk_test_51OjGkmHR45HqFZaD165gYecofq6Hxnpf1STDyJeDkUPbhZlg5VwALwhyPzMfMa9Ra43O5jSgNuLjP3DDR07cu6nQ00FChIpoUO'
stripe.api_key = 'sk_test_51OjGkmHR45HqFZaDeZb7W7ekvHeDROdDKS2OVjJeeMgjmJkYqARs424lvXmKU1U2EQdv9EC9aDA2GuPVHp5BjV79007hexzv7C'
    ...
    if current_user.is_authenticated:
        ...
        if request.method == "POST":
            ...
            rendered = render_template('customer/pdf.html',
                                       invoice=invoice, tax=tax, grandTotal=grandTotal,
                                       customer=customer, orders=orders)
            pdf = pdfkit.from_string(rendered, False, configuration=config)
           #pdf = pdfkit.from_string(rendered, "output_file.pdf", configuration=config)
